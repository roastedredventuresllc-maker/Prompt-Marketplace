...
export const ListPromptsResponse = zod.object({
  ...
  "isGated": zod.boolean().optional().describe('True when content is a truncated preview because the caller has not purchased and is not the author\/admin.'),
  ...
  "authorOrgType": zod.enum(['individual', 'firm']),
  "authorOrgName": zod.string().nullish(),
